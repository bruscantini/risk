function Game() {
    this.territories = [
        ...
        new Territory(20, 'Western Europe', 3, [14, 16, 18, 25]),
...
Game.prototype.changePlayer = function() {
    this.currentPlayer = this.players[(this.currentPlayer.id) % this.players.length];
};
...
Game.prototype.deployUnitsEvenly = function(playerID) {
    ...
    var territories = _.shuffle(player.territories);
